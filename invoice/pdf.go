...
func RenderPDF(invoice *Invoice, layout *Layout, pdfPath *string, T i18n.TranslateFunc) {
	...
	printBlock(pdf, &l.Invoice, boxTitle, boxContent, &l.Style)
	...
	printBlock(pdf, &l.From, boxTitle, boxContent, &l.Style)
	...
	printBlock(pdf, &l.To, boxTitle, boxContent, &l.Style)
	...
	table.SetHeader([]string{c1v,c2v,c3v,c4v })

	pdf.CellFormat(c1w, l.Style.TableHeadHeight, c1v, NO_BORDER, 0, TEXT_ALIGN_LEFT_MID, FILL, 0, "")
	pdf.CellFormat(c2w, l.Style.TableHeadHeight, c2v, NO_BORDER, 0, TEXT_ALIGN_LEFT_MID, FILL, 0, "")
	pdf.CellFormat(c3w, l.Style.TableHeadHeight, c3v, NO_BORDER, 0, TEXT_ALIGN_LEFT_MID, FILL, 0, "")
	pdf.CellFormat(c4w, l.Style.TableHeadHeight, c4v, NO_BORDER, 0, TEXT_ALIGN_LEFT_MID, FILL, 0, "")
	pdf.Ln(l.Style.TableHeadHeight)
	...
	for _, it := range *invoice.Items {
		...
		// render the row in pdf
		pdf.CellFormat(c1w, l.Style.TableRowHeight, c1v, BORDER_BOTTOM, 0, TEXT_ALIGN_LEFT_MID, NO_FILL, 0, "")
		pdf.CellFormat(c2w, l.Style.TableRowHeight, c2v, BORDER_BOTTOM, 0, TEXT_ALIGN_LEFT_MID, NO_FILL, 0, "")
		pdf.CellFormat(c3w, l.Style.TableRowHeight, c3v, BORDER_BOTTOM, 0, TEXT_ALIGN_LEFT_MID, NO_FILL, 0, "")
		pdf.CellFormat(c4w, l.Style.TableRowHeight, c4v, BORDER_BOTTOM, 0, TEXT_ALIGN_LEFT_MID, NO_FILL, 0, "")
	...
	table.Append([]string{c1v,c2v,c3v,c4v })
	// render pdf
	pdf.CellFormat(c1w, l.Style.TableRowHeight, c1v, "TB", 0, TEXT_ALIGN_LEFT_MID, NO_FILL, 0, "")
	pdf.CellFormat(c2w, l.Style.TableRowHeight, c2v, "TB", 0, TEXT_ALIGN_LEFT_MID, NO_FILL, 0, "")
	pdf.CellFormat(c3w, l.Style.TableRowHeight, c3v, "TB", 0, TEXT_ALIGN_LEFT_MID, NO_FILL, 0, "")
	pdf.CellFormat(c4w, l.Style.TableRowHeight, c4v, "TB", 0, TEXT_ALIGN_LEFT_MID, NO_FILL, 0, "")
	pdf.Ln(l.Style.TableRowHeight)

	// vat
	vatAmount := (invoice.Settings.VatRate / 100) * subtotal

	c1v, c2v, c3v, c4v = T("tax"), "", strconv.FormatFloat(invoice.Settings.VatRate, 'f', 2, 64)+" %", ac.FormatMoney(vatAmount)
	// append data for the console output
	table.Append([]string{c1v,c2v,c3v,c4v })


	pdf.CellFormat(c1w, l.Style.TableRowHeight, c1v, "", 0, TEXT_ALIGN_LEFT_MID, NO_FILL, 0, "")
	pdf.CellFormat(c2w, l.Style.TableRowHeight, c2v, "", 0, TEXT_ALIGN_LEFT_MID, NO_FILL, 0, "")
	pdf.CellFormat(c3w, l.Style.TableRowHeight, c3v, "", 0, TEXT_ALIGN_LEFT_MID, NO_FILL, 0, "")
	pdf.CellFormat(c4w, l.Style.TableRowHeight, c4v, "", 0, TEXT_ALIGN_LEFT_MID, NO_FILL, 0, "")
	pdf.Ln(l.Style.TableRowHeight)
	...
	printBlock(pdf, &l.Payments, boxTitle, boxContent, &l.Style)

	// notes
	boxTitle = T("notes")
	boxContent = strings.Join(invoice.Notes, "\n")
	printBlock(pdf, &l.Notes, boxTitle, boxContent, &l.Style)
...
func printBlock(pdf *gofpdf.Fpdf, b *Block, title, content string, s *Style) {
	// write title
